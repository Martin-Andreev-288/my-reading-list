        ...
        {tooltip && (
          <>
            ...
            <div
              id={`${label}-tooltip`}
              role="tooltip"
              className="absolute opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-in-out bottom-full left-0 mb-2 px-3 py-2 text-sm text-gray-100 bg-gray-800 rounded-lg shadow-lg max-w-xs"
            >
              {tooltip}
            </div>
          </>
